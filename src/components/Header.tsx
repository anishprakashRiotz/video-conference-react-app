...
function Header() {
  ...
  const username = useAppSelector(aicte => aicte.auth.userInfo?.name);
  const isDarkTheme = useAppSelector(aicte => aicte.auth.isDarkTheme);
  ...
  const invertTheme = () => {
    const theme = localStorage.getItem("aicte-theme");
    localStorage.setItem("aicte-theme", theme === "light" ? "dark" : "light");
        ...
        <Link to="/">
          <EuiText>
            <h2 style={{ padding: "0 1vw" }}>
              <EuiTextColor color="#0b5cff">SecureMeet</EuiTextColor>
            </h2>
          </EuiText>
        </Link>,
      ],
  ...
  const responsiveSection = [
    {
      items: [
        <Link to="/">
          <EuiText>
            <h2 style={{ padding: "0 1vw" }}>
              <EuiTextColor color="#0b5cff">Aicte</EuiTextColor>
            </h2>
          </EuiText>
        </Link>,
      ],
