...
export default function JoinMeeting() {
    ...
    const getMeetingData = async () => {
      if (params.id && userLoaded) {
        ...
        if (fetchedMeetings.docs.length) {
          ...
          if (meeting.meetingType === "1-on-1") {
          ...
          } else if (meeting.meetingType === "video-conferrence") {
            ...
            if (index !== -1 || isCreator) {
              ...
              createToast({
                title: `Yoou are not invited to the meeting.`,
                type: "danger",
              });
              navigate(user ? "/" : "/login");
            }
  ...
  const appId = 988372699;
  const serverSecret = "50dbd064c13a0f31e96f1fe13fe1858e";
